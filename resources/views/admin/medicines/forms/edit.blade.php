    ...
    <div class="container-fluid mt--7">
        <div class="card" style="margin-top: 12%;">
            <div class="card-body">
                ...
                <form method="POST" action="{{route('forms.update', $med_form->id)}}">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input class="form-control" name="name" type="text" value="{{$med_form->name}}" id="name">
                        </div>
    
                        <div class="form-group col-6">
                            <label for="short_name" class="form-control-label">Abreviación</label>
                            <input class="form-control" name="short_name" type="text" value="{{$med_form->short_name}}" id="short_name">
                        </div>
                    </div>
