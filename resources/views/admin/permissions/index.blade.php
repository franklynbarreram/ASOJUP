...
<div class="container-fluid mt--7">
    <div class="card" style="margin-top: 12%;">
        <div class="card-body">
            ...
            <a class="btn btn-success" href="{{route('permissions.create')}}">Solicitar Permiso</a>
            @endif
                    ...
                    <table class="table align-items-center">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                @if (Auth::user()->role_id == 1)
                                <td class="options-td">
                                    <a href="{{route('permissions.edit', $p->id)}}" data-toggle="modal" data-target="#permission-form" data-perm-id="{{$p->id}}" id="perm-{{$p->id}}" onclick="setModalData(this)">
