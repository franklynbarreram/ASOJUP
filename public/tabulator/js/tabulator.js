...
(function(global, factory) {
  ...
  ColumnManager.prototype.setColumns = function(cols, row) {
    ...
    if (
      ...
      self.table.modExists("responsiveLayout", true)
    ) {
  ...
  ColumnManager.prototype._addColumn = function(
    definition,
    before,
    nextToColumn
  ) {
  ...
  ColumnManager.prototype.findColumn = function(subject) {
    ...
    if (
      (typeof subject === "undefined" ? "undefined" : _typeof(subject)) ==
      "object"
    ) {
  ...
  ColumnManager.prototype.moveColumnActual = function(from, to, after) {
    ...
    if (
      ...
      this.table.modExists("persistence", true) &&
  ...
  ColumnManager.prototype._moveColumnInArray = function(
    columns,
    from,
    to,
    after,
  ...
  ColumnManager.prototype.scrollToColumn = function(
    column,
    position,
    ifVisible
  ) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (column.visible) {
        ...
        if (!ifVisible) {
          ...
          if (
            offset > 0 &&
            offset + colEl.offsetWidth < _this2.element.clientWidth
          ) {
            return false;
          }
        }
        ...
        left = Math.max(
          Math.min(
            left,
            _this2.table.rowManager.element.scrollWidth -
              _this2.table.rowManager.element.clientWidth
          ),
          0
        );
  ...
  ColumnManager.prototype.addColumn = function(
    definition,
    before,
    nextToColumn
  ) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (
        _this3.table.options.responsiveLayout &&
        _this3.table.modExists("responsiveLayout", true)
      ) {
        _this3.table.modules.responsiveLayout.initialize();
      }

      if (_this3.table.modExists("columnCalcs")) {
        _this3.table.modules.columnCalcs.recalc(
          _this3.table.rowManager.activeRows
        );
      }
      ...
      if (_this4.defaultOptionList.indexOf(key) === -1) {
        console.warn(
          "Invalid column definition option in '" +
            (_this4.field || _this4.definition.title) +
            "' column:",
          key
        );
      }
  ...
  Column.prototype.setTooltip = function() {
    ...
    var tooltip =
      def.headerTooltip || def.tooltip === false
        ? def.headerTooltip
    ...
    if (tooltip) {
      if (tooltip === true) {
        if (def.field) {
          self.table.modules.localize.bind("columns|" + def.field, function(
            value
          ) {
  ...
  Column.prototype._buildHeader = function() {
    ...
    if (
      ...
      self.table.modExists("resizeColumns")
    ) {
      self.table.modules.resizeColumns.initializeColumn(
        "header",
        self,
        self.element
      );
    ...
    if (
      def.headerFilter &&
      self.table.modExists("filter") &&
      self.table.modExists("edit")
    ) {
      if (typeof def.headerFilterPlaceholder !== "undefined" && def.field) {
        self.table.modules.localize.setHeaderFilterColumnPlaceholder(
          def.field,
    ...
    if (
      ...
      !self.isGroup &&
      self.table.modExists("moveColumn")
    ) {
    ...
    if (
      (def.topCalc || def.bottomCalc) &&
      self.table.modExists("columnCalcs")
    ) {
    ...
    if (
      self.table.modExists("persistence") &&
  ...
  Column.prototype._buildColumnHeader = function() {
    ...
    if (
      _typeof(table.options.responsiveLayout) &&
      table.modExists("responsiveLayout")
    ) {
    ...
    self.setMinWidth(
      typeof def.minWidth == "undefined"
        ? self.table.options.columnMinWidth
        : parseInt(def.minWidth)
    );
    ...
    self.tooltip =
      self.definition.tooltip || self.definition.tooltip === false
    ...
    self.hozAlign =
      typeof self.definition.hozAlign == "undefined"
        ? self.table.options.cellHozAlign
        : self.definition.hozAlign;

    self.vertAlign =
      typeof self.definition.vertAlign == "undefined"
        ? self.table.options.cellVertAlign
        : self.definition.vertAlign;
  };
  ...
  Column.prototype._formatColumnHeaderTitle = function(el, title) {
    ...
    if (this.definition.titleFormatter && this.table.modExists("format")) {
      ...
      switch (
        typeof contents === "undefined" ? "undefined" : _typeof(contents)
      ) {
        case "object":
    ...
    if (!this.isGroup && alignment !== "top") {
      if (alignment === "bottom") {
        this.element.style.paddingTop =
          this.element.clientHeight - this.contentElement.offsetHeight + "px";
      } else {
        this.element.style.paddingTop =
          (this.element.clientHeight - this.contentElement.offsetHeight) / 2 +
          "px";
      }
    }
  ...
  Column.prototype.updateDefinition = function(updates) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (!_this8.isGroup) {
        ...
        _this8.table.columnManager
          .addColumn(definition, false, _this8)
      ...
      self.element.addEventListener("scroll", function() {
        ...
        if (self.scrollTop != top) {
          ...
          if (self.table.options.ajaxProgressiveLoad == "scroll") {
            self.table.modules.ajax.nextPage(
              self.element.scrollHeight - self.element.clientHeight - top
            );
          }
      ...
      if (rowIndex > -1) {
        ...
        if (position === "nearest") {
          switch (_this9.renderMode) {
            case "classic":
              ...
              position =
                Math.abs(_this9.element.scrollTop - rowTop) >
                Math.abs(
                  _this9.element.scrollTop +
                    _this9.element.clientHeight -
                    rowTop
                )
                  ? "bottom"
                  : "top";
            ...
            case "virtual":
              position =
                Math.abs(_this9.vDomTop - rowIndex) >
                Math.abs(_this9.vDomBottom - rowIndex)
                  ? "bottom"
                  : "top";
        ...
        if (!ifVisible) {
          if (Tabulator.prototype.helpers.elVisible(rowEl)) {
            offset =
              Tabulator.prototype.helpers.elOffset(rowEl).top -
              Tabulator.prototype.helpers.elOffset(_this9.element).top;

            if (
              offset > 0 &&
              offset < _this9.element.clientHeight - rowEl.offsetHeight
            ) {
              return false;
            }
          }
        ...
        switch (position) {
          ...
          case "center":
            if (
              _this9.element.scrollHeight - _this9.element.scrollTop ==
              _this9.element.clientHeight
            ) {
              _this9.element.scrollTop =
                _this9.element.scrollTop +
                (rowEl.offsetTop - _this9.element.scrollTop) -
                (_this9.element.scrollHeight - rowEl.offsetTop) / 2;
            } else {
              _this9.element.scrollTop =
                _this9.element.scrollTop - _this9.element.clientHeight / 2;
            }
          ...
          case "bottom":
            if (
              ...
              _this9.element.scrollTop =
                _this9.element.scrollTop -
                (_this9.element.scrollHeight - rowEl.offsetTop) +
                rowEl.offsetHeight;
            } else {
              _this9.element.scrollTop =
                _this9.element.scrollTop -
  ...
  RowManager.prototype.setData = function(
    data,
    renderInPosition,
    columnsChanged
  ) {
  ...
  RowManager.prototype._setDataActual = function(data, renderInPosition) {
    ...
    if (Array.isArray(data)) {
      ...
      if (
        ...
        this.table.modExists("reactiveData", true)
      ) {
  ...
  RowManager.prototype.addRows = function(data, pos, index) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (
        _this11.table.options.groupBy &&
        _this11.table.modExists("groupRows")
      ) {
        _this11.table.modules.groupRows.updateGroupRows(true);
      } else if (
        _this11.table.options.pagination &&
        _this11.table.modExists("page")
      ) {
      ...
      if (_this11.table.modExists("columnCalcs")) {
        _this11.table.modules.columnCalcs.recalc(
          _this11.table.rowManager.activeRows
        );
      }
  ...
  RowManager.prototype.addRowActual = function(data, pos, index, blockRedraw) {
    ...
    if (
      ...
      this.table.options.paginationAddRow == "page"
    ) {
      ...
      if (top) {
        ...
        if (dispRows.length) {
          ...
          top =
            dispRows.length < this.table.modules.page.getPageSize()
              ? false
              : true;
        }
      }
  ...
  RowManager.prototype._genRemoteRequest = function() {
    ...
    if (table.modExists("page")) {
      ...
      if (options.ajaxSorting) {
        ...
        params[
          this.table.modules.page.paginationDataSentNames.sorters
        ] = sorters;
      }
      ...
      if (options.ajaxFiltering) {
        ...
        params[
          this.table.modules.page.paginationDataSentNames.filters
        ] = filters;
      }
  ...
  RowManager.prototype.sorterRefresh = function(loadOrignalData) {
    ...
    if (options.ajaxSorting) {
      if (
        (options.pagination == "remote" || options.progressiveLoad) &&
        table.modExists("page")
      ) {
        table.modules.page.reset(true);
  ...
  RowManager.prototype.refreshActiveData = function(
    stage,
    skipStage,
    renderInPosition
  ) {
    ...
    if (this.redrawBlock) {
      ...
      if (
        ...
        !table.options.selectablePersistence &&
        table.modExists("selectRow")
      ) {
            ...
            if (this.table.modExists("frozenRows")) {
              if (table.modules.frozenRows.isFrozen()) {
                if (!table.modules.frozenRows.getDisplayIndex()) {
                  table.modules.frozenRows.setDisplayIndex(
                ...
                displayIndex = self.setDisplayRows(
                  table.modules.frozenRows.getRows(
                    this.getDisplayRows(displayIndex - 1)
                  ),
                  displayIndex
                );
          ...
          if (!skipStage) {
            if (table.options.groupBy && table.modExists("groupRows")) {
              if (!table.modules.groupRows.getDisplayIndex()) {
                table.modules.groupRows.setDisplayIndex(
                  this.getNextDisplayIndex()
                );
              }
              ...
              displayIndex = self.setDisplayRows(
                table.modules.groupRows.getRows(
                  this.getDisplayRows(displayIndex - 1)
                ),
                displayIndex
              );
          ...
          if (!skipStage) {
            if (table.options.dataTree && table.modExists("dataTree")) {
              if (!table.modules.dataTree.getDisplayIndex()) {
                table.modules.dataTree.setDisplayIndex(
                  this.getNextDisplayIndex()
                );
              }
              ...
              displayIndex = self.setDisplayRows(
                table.modules.dataTree.getRows(
                  this.getDisplayRows(displayIndex - 1)
                ),
                displayIndex
              );
        ...
        case "page":
          if (!skipStage) {
            if (table.options.pagination && table.modExists("page")) {
              ...
              if (table.modules.page.getMode() == "local") {
                table.modules.page.setMaxRows(
                  this.getDisplayRows(displayIndex - 1).length
                );
              }

              displayIndex = self.setDisplayRows(
                table.modules.page.getRows(
                  this.getDisplayRows(displayIndex - 1)
                ),
                displayIndex
              );
  ...
  RowManager.prototype.setDisplayRows = function(displayRows, index) {
    ...
    if (index == this.displayRows.length - 1) {
      this.displayRowsCount = this.displayRows[
    ...
    if (this.getRenderMode() == "virtual") {
      if (this.redrawBlock) {
        ...
        this._virtualRenderFill(
          topRow === false ? this.displayRowsCount - 1 : topRow,
          true,
          topOffset || 0
        );
  ...
  RowManager.prototype._virtualRenderFill = function(
    position,
    forceMove,
    offset
  ) {
    ...
    if (!position) {
      ...
      var heightOccupied =
        (self.displayRowsCount - position + 1) * self.vDomRowHeight;

      if (heightOccupied < self.height) {
        position -= Math.ceil(
          (self.height - heightOccupied) / self.vDomRowHeight
        );
      ...
      topPad = Math.min(
        Math.max(
          Math.floor(self.vDomWindowBuffer / self.vDomRowHeight),
          self.vDomWindowMinMarginRows
        ),
        position
      );
    ...
    if (
      ...
      Tabulator.prototype.helpers.elVisible(self.element)
    ) {
      ...
      while (
        (rowsHeight <= self.height + self.vDomWindowBuffer ||
          i < self.vDomWindowMinTotalRows) &&
        self.vDomBottom < self.displayRowsCount - 1
      ) {
      ...
      if (!position) {
        ...
        self.vDomBottomPad =
          self.vDomRowHeight * (self.displayRowsCount - self.vDomBottom - 1);

        self.vDomScrollHeight =
          topPadHeight + rowsHeight + self.vDomBottomPad - self.height;
      } else {
        self.vDomTopPad = !forceMove
      ...
      element.style.minWidth = onlyGroupHeaders
        ? self.table.columnManager.getWidth() + "px"
        : "";

      if (self.table.options.groupBy) {
        if (
          self.table.modules.layout.getMode() != "fitDataFill" &&
          self.displayRowsCount == self.table.modules.groupRows.countGroups()
        ) {
  ...
  RowManager.prototype._addTopRow = function(topDiff) {
    ...
    if (this.vDomTop) {
      ...
      if (
        i < this.vDomMaxRenderChain &&
        this.vDomTop &&
        topDiff >= (rows[this.vDomTop - 1].getHeight() || this.vDomRowHeight)
      ) {
  ...
  RowManager.prototype._removeTopRow = function(topDiff) {
    ...
    if (topDiff >= topRowHeight) {
      ...
      this.vDomScrollPosTop += this.vDomTop
        ? topRowHeight
        : topRowHeight + this.vDomWindowBuffer;
  ...
  RowManager.prototype._addBottomRow = function(bottomDiff) {
    ...
    if (this.vDomBottom < this.displayRowsCount - 1) {
      ...
      if (
        ...
        bottomDiff >=
          (rows[this.vDomBottom + 1].getHeight() || this.vDomRowHeight)
      ) {
  ...
  RowManager.prototype.adjustTableSize = function() {
    ...
    if (this.renderMode === "virtual") {
      var otherHeight =
        this.columnManager.getElement().offsetHeight +
        (this.table.footerManager && !this.table.footerManager.external
          ? this.table.footerManager.getElement().offsetHeight
          : 0);
      ...
      if (!this.fixedHeight && initialHeight != this.element.clientHeight) {
        ...
        if (
          (modExists && !this.table.modules.resizeTable.autoResize) ||
          !modExists
        ) {
          this.redraw();
        }
  ...
  var Row = function Row(data, parent) {
    var type =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "row";
  ...
  Row.prototype.generateElement = function() {
    ...
    if (
      self.table.options.selectable !== false &&
      self.table.modExists("selectRow")
    ) {
    ...
    if (
      self.table.options.movableRows !== false &&
      self.table.modExists("moveRow")
    ) {
    ...
    if (
      self.table.options.dataTree !== false &&
      self.table.modExists("dataTree")
    ) {
    ...
    if (
      self.table.options.responsiveLayout === "collapse" &&
      self.table.modExists("responsiveLayout")
    ) {
  ...
  Row.prototype.initialize = function(force) {
    ...
    if (!self.initialized || force) {
      ...
      if (
        ...
        self.table.modExists("resizeRows")
      ) {
  ...
  Row.prototype.updateData = function(updatedData) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (
        _this14.table.options.reactiveData &&
        _this14.table.modExists("reactiveData", true)
      ) {
      ...
      if (_this14.table.modExists("mutator")) {
        ...
        newRowData = _this14.table.modules.mutator.transformRow(
          tempData,
          "data",
          updatedData
        );
      ...
      for (var attrname in updatedData) {
        var columns = _this14.table.columnManager.getColumnsByFieldRoot(
          attrname
        );
      ...
      if (
        _this14.table.options.dataTree !== false &&
        _this14.table.modExists("dataTree") &&
        _this14.table.modules.dataTree.redrawNeeded(updatedData)
      ) {
      ...
      _this14.table.options.rowUpdated.call(
        _this14.table,
        _this14.getComponent()
      );
    ...
    if (index < this.cells.length - 1) {
      for (var i = index + 1; i < this.cells.length; i++) {
        ...
        if (
          ...
          Tabulator.prototype.helpers.elVisible(cell.getElement())
        ) {
          var allowEdit = true;
  ...
  Row.prototype.delete = function() {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (_this15.table.options.history && _this15.table.modExists("history")) {
        if (
          _this15.table.options.groupBy &&
          _this15.table.modExists("groupRows")
        ) {
        ...
        _this15.table.modules.history.action("rowDelete", _this15, {
          data: _this15.getData(),
          pos: !index,
          index: index,
        });
      }
  ...
  Cell.prototype.setValue = function(value, mutate) {
    ...
    if (changed) {
      ...
      this.table.options.dataEdited.call(
        this.table,
    ...
    for (var key in this.defaultOptions) {
      if (key in options) {
        ...
        if (Array.isArray(this.defaultOptions[key])) {
          ...
          _typeof(this.defaultOptions[key]) === "object" &&
          this.defaultOptions[key] !== null
        ) {
          this.options[key] = {};
        } else {
  ...
  Tabulator.prototype._mapDepricatedFunctionality = function() {
    ...
    if (this.options.persistentLayout) {
      ...
      if (
        ...
        typeof this.options.persistence.columns === "undefined"
      ) {
    ...
    if (this.options.persistentSort) {
      ...
      if (
        this.options.persistence !== true &&
        typeof this.options.persistence.sort === "undefined"
      ) {
    ...
    if (this.options.persistentFilter) {
      ...
      if (
        this.options.persistence !== true &&
        typeof this.options.persistence.filter === "undefined"
      ) {
  ...
  Tabulator.prototype._buildElement = function() {
    ...
    if (
      options.persistence &&
      this.modExists("persistence", true) &&
      mod.persistence.config.columns
    ) {
    ...
    if (
      ((options.persistence &&
        this.modExists("persistence", true) &&
        mod.persistence.config.sort) ||
        options.initialSort) &&
      this.modExists("sort", true)
    ) {
      var sorters = [];
    ...
    if (
      ((options.persistence &&
        this.modExists("persistence", true) &&
        mod.persistence.config.filter) ||
        options.initialFilter) &&
      this.modExists("filter", true)
    ) {
      var filters = [];
    ...
    if (self.options.pagination && self.modExists("page")) {
      ...
      if (self.options.pagination == "local") {
        if (self.options.data.length) {
          ...
          if (
            (self.options.ajaxURL || self.options.ajaxURLGenerator) &&
            self.modExists("ajax")
          ) {
            self.modules.ajax
              .loadData(false, true)
        ...
        if (self.options.ajaxURL) {
          self.modules.page
            .setPage(self.options.paginationInitialPage)
            .then(function() {})
            .catch(function() {});
        } else {
  ...
  Tabulator.prototype._setData = function(
    data,
    params,
    config,
    inPosition,
    ...
    if (typeof data === "string") {
      if (data.indexOf("{") == 0 || data.indexOf("[") == 0) {
        ...
        return self.rowManager.setData(
          JSON.parse(data),
          inPosition,
          columnsChanged
        );
        ...
        if (self.modExists("ajax", true)) {
          ...
          if (
            self.options.pagination == "remote" &&
            self.modExists("page", true)
          ) {
            self.modules.page.reset(true, true);
      ...
      if (data) {
        ...
        if (
          self.modExists("ajax") &&
          (self.modules.ajax.getUrl || self.options.ajaxURLGenerator)
        ) {
          if (
            self.options.pagination == "remote" &&
            self.modExists("page", true)
  ...
  Tabulator.prototype.deleteRow = function(index) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      foundRows.sort(function(a, b) {
        return _this21.rowManager.rows.indexOf(a) >
          _this21.rowManager.rows.indexOf(b)
          ? 1
          : -1;
      });
  ...
  Tabulator.prototype.setColumnLayout = function(layout) {
    if (this.modExists("persistence", true)) {
      this.columnManager.setColumns(
        this.modules.persistence.mergeDefinition(this.options.columns, layout)
      );
  ...
  Tabulator.prototype.showColumn = function(field) {
    ...
    if (column) {
      ...
      if (
        ...
        this.modExists("responsiveLayout", true)
      ) {
  ...
  Tabulator.prototype.downloadToTab = function(
    type,
    filename,
    options,
    active
  ...
  Tabulator.prototype.extendModule = function(name, property, values) {
    if (Tabulator.prototype.moduleBindings[name]) {
      ...
      if (source) {
        if (
          (typeof values === "undefined" ? "undefined" : _typeof(values)) ==
          "object"
        ) {
  ...
  Layout.prototype.modes = {
    ...
    fitDataStretch: function fitDataStretch(columns) {
      ...
      columns.forEach(function(column, i) {
        ...
        if (
          _this31.table.options.responsiveLayout
  ...
  Localize.prototype.setHeaderFilterColumnPlaceholder = function(
    column,
    placeholder
  ) {
          ...
          if (value != "undefined") {
            ...
            params =
              typeof accessor.params === "function"
                ? accessor.params(value, data, type, component)
                : accessor.params;
            column.setFieldValue(
              data,
              accessor.accessor(value, data, type, params, component)
            );
          }
        }
      }
  ...
  Ajax.prototype.nextPage = function(diff) {
    ...
    if (!this.loading) {
      margin =
        ...
        this.table.rowManager.getElement().clientHeight * 2;
  ...
  Ajax.prototype._loadDataStandard = function(inPosition, columnsChanged) {
    ...
    return new Promise(function(resolve, reject) {
      _this32
        .sendRequest(inPosition)
        .then(function(data) {
          _this32.table.rowManager
            .setData(data, inPosition, columnsChanged)
            .then(function() {
              resolve();
            })
            .catch(function(e) {
    ...
    if (Array.isArray(data)) {
      data.forEach(function(item, i) {
        output = output.concat(
          self.generateParamsList(item, prefix ? prefix + "[" + i + "]" : i)
        );
      });
    } else if (
  ...
  Ajax.prototype.sendRequest = function(silent) {
    ...
    return new Promise(function(resolve, reject) {
      if (
        ...
        _this33
          .loaderPromise(url, self.config, self.params)
          .then(function(data) {
            if (requestNo === self.requestOrder) {
              if (self.table.options.ajaxResponse) {
                data = self.table.options.ajaxResponse.call(
                  self.table,
                  self.url,
                  self.params,
                  data
  ...
  Ajax.prototype.showLoader = function() {
    var shouldLoad =
      typeof this.table.options.ajaxLoader === "function"
    ...
    if (shouldLoad) {
      ...
      if (this.loadingElement) {
        ...
        this.msgElement.innerHTML = this.table.modules.localize.getText(
          "ajax|loading"
        );
      }
  ...
  Ajax.prototype.defaultLoaderPromise = function(url, config, params) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (config.method.toUpperCase() != "GET") {
        contentType =
          _typeof(self.table.options.ajaxContentType) === "object"
            ? self.table.options.ajaxContentType
            : self.contentTypeFormatters[self.table.options.ajaxContentType];
        if (contentType) {
      ...
      if (url) {
        ...
        if (config.mode == "cors") {
          if (
            typeof config.headers["Access-Control-Allow-Origin"] === "undefined"
          ) {
  ...
  ColumnCalcs.prototype.scrollHorizontal = function(left) {
    var hozAdjust = 0,
      scrollWidth =
        this.table.columnManager.getElement().scrollWidth -
        this.table.element.clientWidth;
  ...
  ColumnCalcs.prototype.rowsToData = function(rows) {
    ...
    rows.forEach(function(row) {
      ...
      if (
        _this35.table.options.dataTree &&
        _this35.table.options.dataTreeChildColumnCalcs
      ) {
        if (row.modules.dataTree.open) {
          var children = _this35.rowsToData(
            _this35.table.modules.dataTree.getFilteredTreeChildren(row)
          );
    ...
    row.generateCells = function() {
      ...
      self.table.columnManager.columnsByIndex.forEach(function(column) {
        ...
        if (
          ...
          self.table.modExists("format")
        ) {
          self.genColumn.modules.format = {
            formatter: self.table.modules.format.getFormatter(
              column.definition[pos + "CalcFormatter"]
            ),
        ...
        if (!_this36.blocked) {
          ...
          if (_this36.customSelection) {
            ...
            if (_this36.table.options.clipboardCopyFormatter) {
              plain = _this36.table.options.clipboardCopyFormatter(
                "plain",
                plain
              );
            }
          } else {
            html = _this36.table.modules.export.getHtml(
              _this36.rowRange,
              _this36.table.options.clipboardCopyStyled,
              _this36.table.options.clipboardCopyConfig,
              "clipboard"
            );
          ...
          _this36.table.options.clipboardCopied.call(
            _this36.table,
            plain,
            html
          );
  ...
  Clipboard.prototype.paste = function(e) {
    ...
    if (this.checkPaseOrigin(e)) {
      ...
      if (rowData) {
        ...
        this.table.options.clipboardPasted.call(
          this.table,
          data,
          rowData,
          rows
        ...
        data[0].forEach(function(value) {
          var column = columns.find(function(column) {
            return (
              ...
              value.trim() &&
              column.definition.title.trim() === value.trim()
            );
          });
  ...
  DataTree.prototype.initialize = function() {
    ...
    this.elementField =
      options.dataTreeElementColumn || (firstCol ? firstCol.field : false);
  ...
  DataTree.prototype.initializeRow = function(row) {
    ...
    var children =
      isArray ||
      (!isArray &&
        (typeof childArray === "undefined"
          ? "undefined"
          : _typeof(childArray)) === "object" &&
        childArray !== null);
  ...
  DataTree.prototype.generateChildren = function(row) {
    ...
    childArray.forEach(function(childData) {
      ...
      if (childRow.modules.dataTree.children) {
        childRow.modules.dataTree.open = _this40.startOpen(
  ...
  Download.prototype.download = function(
    ...
    if (downloadFunc) {
      downloadFunc.call(
        ...
        self.processData(active || "active"),
        options || {},
        buildLink,
        this.config
      );
  ...
  Download.prototype.processColumns = function() {
    ...
    self.table.columnManager.columnsByIndex.forEach(function(column) {
      if (
        column.field &&
        column.definition.download !== false &&
        (column.visible || (!column.visible && column.definition.download))
      ) {
  ...
  Download.prototype.triggerDownload = function(
    data,
    mime,
    type,
    filename,
    ...
    var element = document.createElement("a"),
      ...
      filename =
        filename || "Tabulator." + (typeof type === "function" ? "txt" : type);
  ...
  Download.prototype.downloaders = {
      ...
      function parseGroup(group, calcObj) {
        ...
        if (group.subGroups) {
          group.subGroups.forEach(function(subGroup) {
            parseGroup(
              subGroup,
              calcObj[group.key] ? calcObj[group.key].groups || {} : {}
            );
          });
        } else {
          if (config.columnCalcs) {
    ...
    xlsx: function xlsx(columns, data, options, setFileContents, config) {
      ...
      function generateSheet() {
        ...
        function rowsToSheet() {
          ...
          var range = {
            s: { c: 0, r: 0 },
            e: { c: fields.length, r: rows.length },
          };
        ...
        function generateMerges() {
          ...
          groupColumnIndexs.forEach(function(merges, level) {
            merges.forEach(function(merge) {
              if (merge.type === "hoz") {
                output.push({
                  s: { r: level, c: merge.start },
                  e: { r: level, c: merge.end },
                });
              } else {
                if (level != titles.length - 1) {
                  output.push({
                    s: { r: level, c: merge.start },
                    e: { r: titles.length - 1, c: merge.start },
                  });
                }
              }
            });
    ...
    html: function html(columns, data, options, setFileContents, config) {
      if (this.table.modExists("export", true)) {
        setFileContents(
          this.table.modules.export.getHtml(true, options.style, config),
          "text/html"
        );
      }
    },
    ...
    function success(value) {
      if (self.currentCell === cell) {
        ...
        if (cell.column.modules.validate && self.table.modExists("validate")) {
          valid = self.table.modules.validate.validate(
            cell.column.modules.validate,
            cell.getComponent(),
            value
          );
        }
        ...
        if (valid === true) {
          ...
          rendered();
          self.table.options.validationFailed.call(
            self.table,
            cell.getComponent(),
            value,
            valid
  ...
  Edit.prototype.editors = {
    ...
    input: function input(cell, onRendered, success, cancel, editorParams) {
      ...
      if (
        ...
        _typeof(editorParams.elementAttributes) == "object"
      ) {
      ...
      input.addEventListener("keydown", function(e) {
        switch (e.keyCode) {
          ...
          case 38:
            ...
            if (
              vertNav == "editor" ||
              (vertNav == "hybrid" && input.selectionStart)
            ) {
    ...
    select: function select(cell, onRendered, success, cancel, editorParams) {
      var self = this,
        ...
        initialDisplayValue =
          typeof initialValue !== "undefined" || initialValue === null
            ? initialValue
            : typeof editorParams.defaultValue !== "undefined"
            ? editorParams.defaultValue
            : "",
        input = document.createElement("input"),
      ...
      if (
        Array.isArray(editorParams) ||
        (!Array.isArray(editorParams) &&
          (typeof editorParams === "undefined"
            ? "undefined"
            : _typeof(editorParams)) === "object" &&
          !editorParams.values)
      ) {
        console.warn(
      ...
      function parseItems(inputValues, curentValue) {
        ...
        function processComplexListItem(item) {
          var item = {
            label: editorParams.listItemFormatter
              ? editorParams.listItemFormatter(item.value, item.label)
              : item.label,
            value: item.value,
            element: false,
          };
          ...
          if (
            item.value === curentValue ||
            (!isNaN(parseFloat(item.value)) &&
              !isNaN(parseFloat(item.value)) &&
              parseFloat(item.value) === parseFloat(curentValue))
          ) {
            setCurrentItem(item);
          }
        ...
        if (Array.isArray(inputValues)) {
          inputValues.forEach(function(value) {
            ...
            if (
              ...
              item = {
                label: editorParams.listItemFormatter
                  ? editorParams.listItemFormatter(value, value)
                  : value,
                value: value,
                element: false,
              };
          ...
          for (var key in inputValues) {
            var item = {
              label: editorParams.listItemFormatter
                ? editorParams.listItemFormatter(key, inputValues[key])
                : inputValues[key],
              value: key,
              element: false,
            };
      ...
      function showList() {
        if (!listEl.parentNode) {
          if (editorParams.values === true) {
            ...
            parseItems(
              getUniqueColumnValues(editorParams.values),
              initialDisplayValue
            );
          } else {
      ...
      input.addEventListener("keydown", function(e) {
        ...
        switch (e.keyCode) {
          ...
          case 40:
            ...
            if (
              vertNav == "editor" ||
              (vertNav == "hybrid" && index < dataItems.length - 1)
            ) {
              e.stopImmediatePropagation();
              e.stopPropagation();
              e.preventDefault();
    ...
    autocomplete: function autocomplete(
      ...
      function filterList(term, intialLoad) {
        ...
        if (editorParams.searchFunc) {
          ...
          if (matches instanceof Promise) {
            addNotice(
              typeof editorParams.searchingPlaceholder !== "undefined"
                ? editorParams.searchingPlaceholder
                : "Searching..."
            );
      ...
      function parseItems(inputValues) {
        ...
        if (Array.isArray(inputValues)) {
          inputValues.forEach(function(value) {
            var item = {
              title: editorParams.listItemFormatter
                ? editorParams.listItemFormatter(value, value)
                : value,
              value: value,
            };
      ...
      input.addEventListener("keydown", function(e) {
        ...
        switch (e.keyCode) {
          ...
          case 40:
            ...
            if (
              vertNav == "editor" ||
              (vertNav == "hybrid" && index < displayItems.length - 1)
            ) {
              e.stopImmediatePropagation();
              e.stopPropagation();
              e.preventDefault();
    ...
    progress: function progress(
      ...
      var element = cell.getElement(),
        max =
          typeof editorParams.max === "undefined"
            ? element.getElementsByTagName("div")[0].getAttribute("max") || 100
            : editorParams.max,
        min =
          typeof editorParams.min === "undefined"
            ? element.getElementsByTagName("div")[0].getAttribute("min") || 0
            : editorParams.min,
        percent = (max - min) / 100,
      ...
      function updateValue() {
        var calcVal =
          percent * Math.round(bar.offsetWidth / (element.clientWidth / 100)) +
          min;
        success(calcVal);
      ...
      element.addEventListener("keydown", function(e) {
        switch (e.keyCode) {
          case 39:
            //right arrow
            bar.style.width =
              bar.clientWidth + element.clientWidth / 100 + "px";
            break;
  ...
  Export.prototype.generateHeaderElements = function() {
    ...
    rows.forEach(function(row) {
      ...
      _this47.mapElementStyles(
        _this47.table.columnManager.getHeadersElement(),
        headerEl,
        [
          "border-top",
          "border-left",
      ...
      row.forEach(function(column) {
        ...
        var classNames = column.column.definition.cssClass
          ? column.column.definition.cssClass.split(" ")
          : [];
        ...
        _this47.mapElementStyles(column.column.getElement(), cellEl, [
          "text-align",
          "border-top",
          "border-left",
          "border-right",
        ...
        _this47.mapElementStyles(column.column.contentElement, cellEl, [
          "padding-top",
          "padding-left",
          "padding-right",
          "padding-bottom",
        ...
        if (column.column.parent) {
          _this47.mapElementStyles(column.column.parent.groupElement, cellEl, [
            "border-top",
          ]);
        }
  ...
  Export.prototype.generateBodyElements = function(rows) {
    ...
    rowFormatter = this.table.options[
      "rowFormatter" +
    ...
    if (this.cloneTableStyle && window.getComputedStyle) {
      ...
      firstGroup = this.table.element.getElementsByClassName(
        "tabulator-group"
      )[0];
    ...
    rows.forEach(function(row, i) {
      ...
      switch (row.type) {
        case "group":
          ...
          _this48.mapElementStyles(firstGroup, rowEl, [
            "border-top",
            "border-left",
            "border-right",
            "border-bottom",
          ...
          _this48.mapElementStyles(firstGroup, cellEl, [
            "padding-top",
            "padding-left",
            "padding-right",
            "padding-bottom",
        ...
        case "row":
          if (
            _this48.table.options.dataTree &&
            _this48.config.dataTree === false &&
          ...
          columns.forEach(function(column, i) {
            ...
            if (
              _this48.table.modExists("format") &&
              _this48.config.formatCells !== false
            ) {
              value = _this48.table.modules.format.formatExportValue(
                cellWrapper,
                _this48.colVisProp
              );
            } else {
            ...
            if (firstCell) {
              _this48.mapElementStyles(firstCell, cellEl, [
                "padding-top",
                "padding-left",
                "padding-right",
                "padding-bottom",
            ...
            if (
              ...
              if (
                (treeElementField && treeElementField == column.field) ||
                (!treeElementField && i == 0)
              ) {
                if (row.modules.dataTree.controlEl) {
                  cellEl.insertBefore(
                    row.modules.dataTree.controlEl.cloneNode(true),
                    cellEl.firstChild
                  );
                }
                if (row.modules.dataTree.branchEl) {
                  cellEl.insertBefore(
                    row.modules.dataTree.branchEl.cloneNode(true),
                    cellEl.firstChild
                  );
                }
              }
          ...
          styleRow =
            row.type == "calc" ? calcRow : i % 2 && evenRow ? evenRow : oddRow;

          _this48.mapElementStyles(styleRow, rowEl, [
            "border-top",
            "border-left",
            "border-right",
            "border-bottom",
  ...
  Export.prototype.columnVisCheck = function(column) {
    return (
      column.definition[this.colVisProp] !== false &&
      (column.visible ||
        (!column.visible && column.definition[this.colVisProp]))
    );
  };
                ...
                filterFunc = function filterFunc(data) {
                  ...
                  params =
                    typeof params === "function"
                      ? params(value, fieldVal, data)
                      : params;

                  return self.filters[column.definition.headerFilterFunc](
                    value,
                    fieldVal,
                    data,
                    params
  ...
  Filter.prototype.generateHeaderFilterElement = function(
    column,
    initialValue,
    reinitialize
  ) {
    ...
    if (field) {
      ...
      if (editor) {
        ...
        params =
          typeof params === "function" ? params.call(self.table) : params;
        ...
        if (field) {
          self.table.modules.localize.bind(
            ...
            function(value) {
              editorElement.setAttribute(
                ...
                typeof value !== "undefined" && value
                  ? value
                  : self.table.modules.localize.getText("headerFilters|default")
              );
            }
          );
        } else {
          self.table.modules.localize.bind("headerFilters|default", function(
            value
          ) {
            editorElement.setAttribute(
              "placeholder",
              typeof self.column.definition.headerFilterPlaceholder !==
                "undefined" && self.column.definition.headerFilterPlaceholder
  ...
  Filter.prototype.findFilter = function(filter) {
    ...
    if (typeof filter.field == "function") {
      ...
      if (self.filters[filter.type]) {
        ...
        if (column) {
          filterFunc = function filterFunc(data) {
            return self.filters[filter.type](
              filter.value,
  ...
  Filter.prototype.filter = function(rowList, filters) {
    ...
    if (
      ...
      (self.filterList.length || Object.keys(self.headerFilters).length)
    ) {
    ...
    if (self.table.options.dataFiltered) {
      ...
      self.table.options.dataFiltered.call(
        self.table,
        self.getFilters(),
        activeRowComponents
      );
  ...
  Format.prototype.lookupFormatter = function(column, type) {
    ...
    //set column formatter
    switch (
      typeof formatter === "undefined" ? "undefined" : _typeof(formatter)
    ) {
      case "string":
        if (formatter === "tick") {
          formatter = "tickCross";
  ...
  Format.prototype.formatters = {
    ...
    datetimediff: function datetime(cell, formatterParams, onRendered) {
      ...
      var suffix =
        typeof formatterParams.suffix !== "undefined"
          ...
          : false;
      var unit =
        typeof formatterParams.unit !== "undefined"
          ? formatterParams.unit
          : undefined;
      var humanize =
    ...
    traffic: function traffic(cell, formatterParams, onRendered) {
      var value = this.sanitizeHTML(cell.getValue()) || 0,
        ...
        max =
          formatterParams && formatterParams.max ? formatterParams.max : 100,
    ...
    progress: function progress(cell, formatterParams, onRendered) {
      ...
      var value = this.sanitizeHTML(cell.getValue()) || 0,
        ...
        min = formatterParams && formatterParams.min ? formatterParams.min : 0,
        legendAlign =
          formatterParams && formatterParams.legendAlign
    ...
    rownum: function rownum(cell, formatterParams, onRendered) {
      return (
        this.table.rowManager.activeRows.indexOf(cell.getRow()._getSelf()) + 1
      );
    },
    ...
    responsiveCollapse: function responsiveCollapse(
      cell,
      formatterParams,
      onRendered
    ) {
  ...
  FrozenColumns.prototype.calcMargins = function() {
    ...
    this.rightMargin =
      this._calcSpace(this.rightColumns, this.rightColumns.length) + "px";
  ...
  FrozenColumns.prototype.layoutColumnPosition = function(allCells) {
    ...
    this.leftColumns.forEach(function(column, i) {
      column.modules.frozen.margin =
        _this53._calcSpace(_this53.leftColumns, i) +
        _this53.table.columnManager.scrollLeft +
        "px";
    ...
    this.rightColumns.forEach(function(column, i) {
      column.modules.frozen.margin =
        _this53.rightPadding -
        _this53._calcSpace(_this53.rightColumns, i + 1) +
        "px";
  ...
  Group.prototype.addBindings = function() {
    ...
    if (self.groupManager.table.options.groupClick) {
      self.element.addEventListener("click", function(e) {
        self.groupManager.table.options.groupClick.call(
          self.groupManager.table,
          e,
          self.getComponent()
        );
      });
    ...
    if (self.groupManager.table.options.groupDblClick) {
      self.element.addEventListener("dblclick", function(e) {
        self.groupManager.table.options.groupDblClick.call(
          self.groupManager.table,
          e,
          self.getComponent()
        );
    ...
    if (self.groupManager.table.options.groupContext) {
      self.element.addEventListener("contextmenu", function(e) {
        self.groupManager.table.options.groupContext.call(
          self.groupManager.table,
          e,
          self.getComponent()
        );
    ...
    if (self.groupManager.table.options.groupToggleElement) {
      toggleElement =
        self.groupManager.table.options.groupToggleElement == "arrow"
          ? self.arrowElement
          : self.element;
    ...
    if (this.visible) {
      if (this.groupList.length) {
        ...
        if (
          ...
          this.calcs.top = this.groupManager.table.modules.columnCalcs.generateTopRow(
            this.rows
          );
        ...
        if (
          ...
          this.calcs.bottom = this.groupManager.table.modules.columnCalcs.generateBottomRow(
            this.rows
          );
  ...
  GroupRows.prototype.initialize = function() {
    ...
    if (groupHeader) {
      self.headerGenerator = Array.isArray(groupHeader)
        ? groupHeader
        : [groupHeader];
    }
  ...
  GroupRows.prototype.updateGroupRows = function(force) {
    ...
    if (force) {
      var displayIndex = self.table.rowManager.setDisplayRows(
        output,
  ...
  HtmlTableImport.prototype._extractOptions = function(
    element,
    options,
    defaultOptions
  ) {
    var attributes = element.attributes;
    var optionsArr = defaultOptions
    ...
    for (var index in attributes) {
      ...
      if (
        attrib &&
        (typeof attrib === "undefined" ? "undefined" : _typeof(attrib)) ==
          "object" &&
        attrib.name &&
  ...
  Menu.prototype.initializeColumnHeader = function(column) {
    ...
    if (column.definition.headerContextMenu) {
      column.getElement().addEventListener("contextmenu", function(e) {
        var menu =
          typeof column.definition.headerContextMenu == "function"
            ? column.definition.headerContextMenu()
            : column.definition.headerContextMenu;
    ...
    if (column.definition.headerMenu) {
      ...
      headerMenuEl.addEventListener("click", function(e) {
        var menu =
          typeof column.definition.headerMenu == "function"
            ? column.definition.headerMenu()
            : column.definition.headerMenu;
        e.stopPropagation();
        e.preventDefault();
  ...
  Menu.prototype.initializeCell = function(cell) {
    ...
    cell.getElement().addEventListener("contextmenu", function(e) {
      var menu =
        typeof cell.column.definition.contextMenu == "function"
          ? cell.column.definition.contextMenu()
          : cell.column.definition.contextMenu;
  ...
  Menu.prototype.initializeRow = function(row) {
    ...
    row.getElement().addEventListener("contextmenu", function(e) {
      var menu =
        typeof _this60.table.options.rowContextMenu == "function"
          ? _this60.table.options.rowContextMenu()
          : _this60.table.options.rowContextMenu;
        ...
        if (column.parent === self.moving.parent) {
          if (
            (self.touchMove ? e.touches[0].pageX : e.pageX) -
              Tabulator.prototype.helpers.elOffset(colEl).left +
              self.table.columnManager.element.scrollLeft >
            column.getWidth() / 2
          ) {
  ...
  MoveColumns.prototype.startMove = function(e, column) {
    ...
    this.startX =
      ...
      Tabulator.prototype.helpers.elOffset(element).left;
  ...
  MoveColumns.prototype.moveHover = function(e) {
    var self = this,
      ...
      xPos =
        (self.touchMove ? e.touches[0].pageX : e.pageX) -
        Tabulator.prototype.helpers.elOffset(columnHolder).left +
        scrollLeft,
      scrollPos;
  ...
  MoveRows.prototype.initializeGroupHeader = function(group) {
    ...
    config.mousemove = function(e) {
      if (
        e.pageY -
          Tabulator.prototype.helpers.elOffset(group.element).top +
  ...
  MoveRows.prototype.initializeRow = function(row) {
    ...
    config.mousemove = function(e) {
      if (
        e.pageY -
          Tabulator.prototype.helpers.elOffset(row.element).top +
          self.table.rowManager.element.scrollTop >
        row.getHeight() / 2
      ) {
  ...
  Page.prototype.initialize = function(hidden) {
    ...
    for (var key in self.table.options.paginationDataSent) {
      self.paginationDataSentNames[key] =
        self.table.options.paginationDataSent[key];
    }

    for (var _key2 in self.table.options.paginationDataReceived) {
      self.paginationDataReceivedNames[_key2] =
        self.table.options.paginationDataReceived[_key2];
    }
    ...
    self.size =
      self.table.options.paginationSize ||
      Math.floor(self.table.rowManager.getElement().clientHeight / 24);
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (page > 0 && page <= _this63.max) {
        ...
        if (
          ...
          self.table.modExists("persistence", true) &&
  ...
  Page.prototype.setPageToRow = function(row) {
    ...
    return new Promise(function(resolve, reject) {
      var rows = _this64.table.rowManager.getDisplayRows(
        _this64.displayIndex - 1
      );
  ...
  Page.prototype.previousPage = function() {
    ...
    return new Promise(function(resolve, reject) {
      if (_this65.page > 1) {
        ...
        if (
          _this65.table.options.persistence &&
          _this65.table.modExists("persistence", true) &&
          _this65.table.modules.persistence.config.page
        ) {
  ...
  Page.prototype.nextPage = function() {
    ...
    return new Promise(function(resolve, reject) {
      if (_this66.page < _this66.max) {
        ...
        if (
          _this66.table.options.persistence &&
          _this66.table.modExists("persistence", true) &&
          _this66.table.modules.persistence.config.page
        ) {
    ...
    return new Promise(function(resolve, reject) {
      switch (_this67.mode) {
        case "local":
          ...
          _this67.table.options.pageLoaded.call(
            _this67.table,
            _this67.getPage()
          );
          resolve();
  ...
  Page.prototype._getRemotePage = function() {
    ...
    return new Promise(function(resolve, reject) {
      ...
      oldParams = Tabulator.prototype.helpers.deepClone(
      ...
      //set sort data if defined
      if (
        _this68.table.options.ajaxSorting &&
        _this68.table.modExists("sort")
      ) {
      ...
      //set filter data if defined
      if (
        _this68.table.options.ajaxFiltering &&
        _this68.table.modExists("filter")
      ) {
      ...
      self.table.modules.ajax
        .sendRequest(_this68.progressiveLoad)
        .then(function(data) {
  ...
  Page.prototype._parseRemoteData = function(data) {
    ...
    if (
      typeof data[this.paginationDataReceivedNames.last_page] === "undefined"
    ) {
      console.warn(
    ...
    if (data[this.paginationDataReceivedNames.data]) {
      this.max =
        parseInt(data[this.paginationDataReceivedNames.last_page]) || 1;
      ...
      if (this.progressiveLoad) {
        switch (this.mode) {
          case "progressive_load":
            if (this.page == 1) {
              this.table.rowManager.setData(
                data[this.paginationDataReceivedNames.data],
                false,
                this.initialLoad && this.page == 1
              );
            } else {
          ...
          case "progressive_scroll":
            data = this.table.rowManager
              .getData()
              .concat(data[this.paginationDataReceivedNames.data]);
      ...
      console.warn(
        "Remote Pagination Error - Server response missing '" +
          this.paginationDataReceivedNames.data +
          "' property"
      );
    }
  };
  ...
  Persistence.prototype.initialize = function() {
    ...
    if (this.config.page) {
      ...
      if (retreivedData) {
        if (
          typeof retreivedData.paginationSize !== "undefined" &&
        ...
        if (
          typeof retreivedData.paginationInitialPage !== "undefined" &&
          (this.config.page === true || this.config.page.page)
        ) {
          this.table.options.paginationInitialPage =
            retreivedData.paginationInitialPage;
        }
      }
    }
    ...
    if (this.config.group) {
      ...
      if (retreivedData) {
        if (
          typeof retreivedData.groupBy !== "undefined" &&
          (this.config.group === true || this.config.group.groupBy)
        ) {
          this.table.options.groupBy = retreivedData.groupBy;
        }
        if (
          typeof retreivedData.groupStartOpen !== "undefined" &&
          (this.config.group === true || this.config.group.groupStartOpen)
        ) {
          this.table.options.groupStartOpen = retreivedData.groupStartOpen;
        }
        if (
          typeof retreivedData.groupHeader !== "undefined" &&
  ...
  Print.prototype.printFullscreen = function(visible, style, config) {
    var scrollX = window.scrollX,
      ...
      tableEl = this.table.modules.export.genereateTable(
  ...
  ResizeColumns.prototype._checkResizability = function(column) {
    return typeof column.definition.resizable != "undefined"
  ...
  ResponsiveLayout.prototype.initialize = function() {
    ...
    for (
      var _iterator = this.table.columnManager.columnsByIndex,
  ...
  ResponsiveLayout.prototype.updateColumnVisibility = function(
    column,
    visible
  ) {
    var index;
  ...
  ResponsiveLayout.prototype.update = function() {
    ...
    while (working) {
      var width =
        self.table.modules.layout.getMode() == "fitColumns"
  ...
  SelectRow.prototype.initializeRow = function(row) {
    ...
    if (
      self.table.options.selectableCheck.call(this.table, row.getComponent())
    ) {
        ...
        if (self.table.options.selectableRangeMode === "click") {
          element.addEventListener("click", function(e) {
            if (e.shiftKey) {
              ...
              var lastClickedRowIdx = self.table.rowManager.getDisplayRowIndex(
                self.lastClickedRow
              );
              var rowIdx = self.table.rowManager.getDisplayRowIndex(row);

              var fromRowIdx =
                lastClickedRowIdx <= rowIdx ? lastClickedRowIdx : rowIdx;
              var toRowIdx =
                lastClickedRowIdx >= rowIdx ? lastClickedRowIdx : rowIdx;

              var rows = self.table.rowManager.getDisplayRows().slice(0);
              var toggledRows = rows.splice(
                fromRowIdx,
                toRowIdx - fromRowIdx + 1
              );
              ...
              if (e.ctrlKey || e.metaKey) {
                toggledRows.forEach(function(toggledRow) {
                  if (toggledRow !== self.lastClickedRow) {
                    if (
                      self.table.options.selectable !== true &&
                      !self.isRowSelected(row)
                    ) {
                      if (
                        self.selectedRows.length < self.table.options.selectable
                      ) {
  ...
  Sort.prototype.initializeColumn = function(column, content) {
    ...
    column.modules.sort = {
      ...
      tristate:
        typeof column.definition.headerSortTristate !== "undefined"
          ? column.definition.headerSortTristate
          : this.table.options.headerSortTristate,
    };

    if (
      typeof column.definition.headerSort === "undefined"
        ? this.table.options.headerSort !== false
        : column.definition.headerSort !== false
    ) {
      colEl = column.getElement();
      ...
      colEl.addEventListener("click", function(e) {
        ...
        if (column.modules.sort) {
          ...
          if (
            self.table.options.columnHeaderSortMulti &&
  ...
  Sort.prototype.sort = function(data) {
    ...
    if (self.table.options.dataSorted) {
      self.table.options.dataSorted.call(
        self.table,
        self.getSort(),
        self.table.rowManager.getComponents("active")
      );
    }
  };
  ...
  Sort.prototype._sortItem = function(data, column, dir, sortList, i) {
    ...
    var params =
      typeof column.modules.sort.params === "function"
        ? column.modules.sort.params(column.getComponent(), dir)
        : column.modules.sort.params;
  ...
  Sort.prototype.sorters = {
    ...
    date: function date(a, b, aRow, bRow, column, dir, params) {
      ...
      return this.sorters.datetime.call(
        this,
        a,
        b,
        aRow,
